            ...
            <div class="col-lg-9">
              ...
              >
                ...
                <div className="d-flex">
                  <p className="mx-4 mt-2" style={{ fontSize: "18px" }}>
                    Sort by:{" "}
                  </p>
                  <Dropdown>
                    <Dropdown.Toggle
              ...
              <div
                class="row card shadow p-0 mb-4"
              ...
              >
                  ...
                  >
                    <thead>
                      <tr>
                        ...
                        <th
                          scope="col "
                          style={{ background: "orange", textAlign: "left" }}
                          className="thead"
                        >
                          {" "}
                          <span style={{ color: "#777777" }}>
                    ...
                    <tbody>
                      {items.map((item) => (
                        ...
                        >
                          <td>
                            <ul
                              className="cart_list d-block d-xl-flex align-items-center mt-5 "
                              style={{ width: "100%" }}
                            >
                ...
                <div className="d-flex  justify-content-between">
                  ...
                  <h5 style={{ color: "#F70000" }}>Cancel order</h5>
                </div>
              </div>
