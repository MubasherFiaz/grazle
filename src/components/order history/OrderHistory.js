            ...
            <div className="col-xl-12">
              <div className="account_user_deails pl40-md pl0 pl0-md">
                <div className="ui_kit_tab style2">
                  <ul
                    className="nav nav-tabs mb15 customorder"
                    id="myTab"
                    role="tablist"
                  >
                  ...
                  <div className="tab-content pt20 row" id="myTabContent">
                    ...
                    >
                      <div className="account_details_page form_grid">
                        {items.map((item) => (
                          <div
                            className="card shadow active mb-3 me-0 p-4"
                            style={{
                              border: cancelButtonState[item.id]
                                ? "1px solid #f70000"
                                : "1px solid #Fff",
                              borderRadius: "22px",
                            }}
                              ...
                              <div className="customcolumn11">
                                {cancelButtonState[item.id] && (
                                  <button
                                    ...
                                    className="btn me-3 customcolumn11btn"
                                    style={{
                                      color: "#F70000",
                                      background: "none ",
                                    }}
                                ...
                                <i
                                  ...
                                  onClick={() => toggleCancelButton(item.id)}
                                ></i>
                              </div>
                            </div>
                    ...
                    >
                      <div className="account_details_page form_grid">
                        {items.map((item) => (
                          <div
                            className="card shadow mb-3 p-4 me-0"
                            style={{
                              border: cancelButtonState[item.id]
                                ? "1px solid #f70000"
                                : "1px solid #Fff",
