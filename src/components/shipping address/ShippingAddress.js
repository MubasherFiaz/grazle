    ...
    <div class="container">
        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-4">
                                        ...
                                        <input class="form-control" type="number" placeholder="State"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-4">
                                        ...
                                        <input class="form-control" type="number" placeholder="Region"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group d-flex mb0">
                                        ...
                                        <button type="button" class="btn btn-thm2 me-3">Use this
                                            Addresss</button>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-4 col-xl-3">
                <div class="order_sidebar_widget style2 shadow" style={{border: "none", borderRadius: "15px"}}>
                    ...
                    <ul>
                        ...
                        <li class="subtitle">
                            <p>Discount <span class="float-end">$66.00</span></p>
                        </li> 
                        <li class="subtitle">
                            <p>Cart Total <span class="float-end">$66.00</span></p>
                        </li> 
                    </ul> 
                </div>
            </div>
            ...
            <div class="col-lg-9 col-xl-9">
                <div class="card shadow p-4">
                    <div class="account_details_page form_grid">
                        ...
                        <div class="p-4 mb-4" style={{border: "2px solid #F70000", background: "#fdf5f5", borderRadius: "11px"}}>
                            <form class="contact_form" name="contact_form" action="#" method="post" novalidate>
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-check">
                                            ...
                                            <label class="form-label" for="flexRadioDefault1"
                                                style={{color: "black"}}>Credit Card
                                            </label>
                                        </div>

                                    </div>

                                    <p  style={{color: "black"}}>Pay securely using your visa, maestro, Discover , or American express card.</p>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-4">
                                            ...
                                            <input class="form-control" type="number" placeholder="Name of card"/>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        <input class="form-check-input me-4 mt-1" type="radio"
                                            name="flexRadioDefault" id="flexRadioDefault1"/>
                                        <label class="form-label" for="flexRadioDefault1"
                                            style={{color: "black", fontSize: "18px"}}>Visa
                                        </label>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        <input class="form-check-input me-4 mt-1" type="radio"
                                            name="flexRadioDefault" id="flexRadioDefault1"/>
                                        <label class="form-label" for="flexRadioDefault1"
                                            style={{color: "black", fontSize: "18px"}}>Master Card
                                        </label>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        <input class="form-check-input me-4 mt-1" type="radio"
                                            name="flexRadioDefault" id="flexRadioDefault1"/>
                                        <label class="form-label" for="flexRadioDefault1"
                                            style={{color: "black", fontSize: "18px"}}>Cash on Delivery
                                        </label>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3"> 
                                    <button type="button" class="btn btn-thm1111 me-3 w-100">Pay $567.00</button>
                                </div>
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-label" for="flexCheckDefault"
                                        style={{color: "#777777"}}>
                                        By Clicking this, I agree all Terms & Conditions and Privacy & Ploicy
                                    </label>
                                </div>
