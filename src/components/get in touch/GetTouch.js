...
const GetTouch = () => {
  return (
    ...
    <div className="container">
        <div className="row">
    <div className="row d-flex justify-content-center align-items-center my-3" style={{width:"100%", backgroundColor:"#F8F8F8",color:"#909198",height:"40px"}}>Home - Contact Us</div>
            ...
            <div className="col-md-8 col-12 mb-md-0 mb-4 track">
                <div className="card shadow p-4 customtouch">
                    ...
                    <Link to="" className="btn banner-btn btn-thm1111  px-lg-4 py-lg-2 px-sm-2 py-sm-1">Send Message</Link>
                </div>
                </div>
                </div>
            </div>
            <div className='col-md-4 col-12 '>
            <div className="card p-3" style={{ backgroundColor: "#5F0505",borderRadius:"22px" }}>
            <div className='text-white mb-md-4 mb-2 customaddressdiv'>
                <h2> Address</h2>
                <p className='p-0 m-0'>8567 Preston Rd. Inglewood, Maine 9875</p>
            </div>
            <div className='text-white mb-md-4 mb-2 customaddressdiv'>
                <h2> Contact</h2>
